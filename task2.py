...
максимальной длиной)
P.S.: скорее всего я переборщил и применение функций и меню здесь
не нужно по условию задания, я добавил их чисто от себя, чтобы не дублировать
один и тот же код, на логику работы циклов for и while напрямую они не влияют.
Еще в некоторых местах использовал однострочные циклы (строка №16 и №34).
"""
